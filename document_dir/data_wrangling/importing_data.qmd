...
::: callout-caution
Do not use Apple Pages to open provided .xlsx or CSV files! Automatic changes done to the file when opened by Pages will cause the file to fail to import to R.
:::
